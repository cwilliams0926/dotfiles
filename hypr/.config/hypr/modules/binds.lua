...
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("~/.config/custom_scripts/brightness +5%"), { repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("~/.config/custom_scripts/brightness 5%-"), { repeating = true })
